...
set libname my_eth_eth_tse_0_altera_lvds_core20_191_a2sc7yy 
...
foreach lvds_instance_name $lvds_instance_name_list {  
   ...
   for {set ichan 0} {$ichan < $num_chan} {incr ichan} { 
      if {[catch {get_node_info -name [altera_iosubsystem_get_src_pll_in_pin ${lvds_core_instance_name}|channels[$ichan].soft_cdr.ioserdesdpa.serdes_dpa_inst~dpa_reg]} pll_in_pin]} {
         if {$use_external_pll} {
      ...
      altera_iosubsystem_create_generated_clock -source ${pll_in_pin} -name ${lvds_instance_name}_dpa_ck_name_$ichan -divide_by $fclk_divide_by -multiply_by $fclk_multiply_by  -target ${lvds_core_instance_name}|channels[$ichan].soft_cdr.ioserdesdpa.serdes_dpa_inst~dpa_reg 
      lappend periphery_clocks ${lvds_instance_name}_dpa_ck_name_$ichan
      if {[is_fitter_in_qhd_mode]} {
         altera_iosubsystem_create_generated_clock -invert 1 -source ${lvds_core_instance_name}|channels[$ichan].soft_cdr.ioserdesdpa.serdes_dpa_inst~dpa_reg -name ${lvds_instance_name}_core_ck_name_$ichan -divide_by $j_factor -target ${lvds_core_instance_name}|channels[$ichan].soft_cdr.ioserdesdpa.serdes_dpa_inst~O_PCLK 
      } else {
         altera_iosubsystem_create_generated_clock -invert 1 -source ${lvds_core_instance_name}|channels[$ichan].soft_cdr.ioserdesdpa.serdes_dpa_inst~dpa_reg -name ${lvds_instance_name}_core_ck_name_$ichan -divide_by $j_factor -target ${lvds_core_instance_name}|channels[$ichan].soft_cdr.divfwdclk 
      }
      lappend core_clocks ${lvds_instance_name}_core_ck_name_$ichan
      for {set index 0} {$index < $j_factor} {incr index} { 
         altera_iosubsystem_create_generated_clock -source ${lvds_core_instance_name}|channels[${ichan}].soft_cdr.ioserdesdpa.serdes_dpa_inst~dpa_reg -name ${lvds_instance_name}_dpa_data_out_${ichan}_$index -divide_by $j_factor -target ${lvds_core_instance_name}|channels[$ichan].soft_cdr.ioserdesdpa.serdes_dpa_inst|rxdata[$index]	
         altera_iosubsystem_create_generated_clock -remove_clock 0 -add 1 -invert 1 -source ${lvds_core_instance_name}|channels[${ichan}].soft_cdr.ioserdesdpa.serdes_dpa_inst~dpa_reg -name ${lvds_instance_name}_dpa_data_out_${ichan}_${index}_neg -divide_by $j_factor -target ${lvds_core_instance_name}|channels[$ichan].soft_cdr.ioserdesdpa.serdes_dpa_inst|rxdata[$index]
   ...
   if {$fit_flow == 1} { 
      set_max_delay -from ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst~dpa_reg -to [get_fanouts ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst|dpalock] [expr 2*$slow_clock_period_ns] 
   } else { 
      set_false_path -from ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst~dpa_reg -to [get_fanouts ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst|dpalock] 
   } 
   ...
   set through_pin_collection [get_pins -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst|fiforeset] 
   if {[get_collection_size $through_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst|fiforeset] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst|fiforeset] 
      } 
   } 
   ...
   set through_pin_collection [get_pins -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst|dpareset] 
   if {[get_collection_size $through_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst|dpareset] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -through [get_pins -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.serdes_dpa_inst|dpareset] 
      } 
   } 
   ...
   set to_pin_collection [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.soft_bitslip.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] 
   if {[get_collection_size $to_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.soft_bitslip.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.soft_bitslip.rx_bitslip|bitslip_reset_synchronizer|sync_reg[0]] 
      } 
   } 
   ...
   set to_pin_collection [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.soft_bitslip.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] 
   if {[get_collection_size $to_pin_collection] > 0} { 
      if {$fit_flow == 1} { 
         set_max_delay -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.soft_bitslip.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] [expr 2*$slow_clock_period_ns] 
      } else { 
         set_false_path -to [get_keepers -nowarn ${lvds_core_instance_name}|channels[*].soft_cdr.ioserdesdpa.soft_bitslip.rx_bitslip|bitslip_ctrl_synchronizer|sync_reg[0]] 
      } 
   } 
